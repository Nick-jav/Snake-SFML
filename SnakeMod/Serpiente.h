...
public:
    ...
    spriteColaSerpiente.setPosition(400, 300);
    texturaColaSerpiente.loadFromFile("cola.png");
    spriteColaSerpiente.setTexture(texturaColaSerpiente);
    spriteColaSerpiente.setOrigin(spriteColaSerpiente.getGlobalBounds().width/2, spriteColaSerpiente.getGlobalBounds().height/2);
    }
...
void agregarCola() {
    ...
    void draw(sf::RenderTarget &target, sf::RenderStates states) const override {
        ...
        sf::Sprite segmentSprite = spriteColaSerpiente; // Copia el sprite de la cabeza
